...
// P2P photography and video, which does not yet exist in this build. The
// `scene` glyph is an original line-art emblem (see components/media/Scene)
// used instead of a fake photo, so nothing here is mistakable for a real
// picture. Nothing here should be read as a claim about real people, places,
// or footage.
//
...
// component will use it instead of the generated gradient + glyph.
...
export type MediaAsset = {
  ...
  base: string;
  /** Original line-art emblem shown over the gradient until a real photo/video exists. */
  scene?: SceneVariant;
